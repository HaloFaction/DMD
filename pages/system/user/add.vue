<template>
	<view class="uni-container">
		<uni-forms ref="form" v-model="formData" :rules="rules" validateTrigger="bind" @submit="submit">
			...
			<uni-forms-item name="email" label="备注" >
				<input placeholder="备注" @input="binddata('email', $event.detail.value)" class="uni-input-border" :value="formData.email" />
			</uni-forms-item>
	...
	export default {
		data() {
			return {
				...
				rules: {
					...getValidator(["username", "password", "role", "mobile"])
				},
				roles: []
			}
		},
